                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Data Berkas Masuk Perbulan</h6>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-primary"></i> K Pusat
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-success"></i> KC Ciwidey
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-info"></i> KC Katapang
                                        </span>
                                    </div>
                                </div>
                            </div>
